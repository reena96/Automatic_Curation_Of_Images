...
filename=""
#Ensure that your darknet is in Home directory
userhome = os.path.expanduser('~')    #/home/reena-mary
...
def classify_url():
    ...
    #imageurl="http://drop.ndtv.com/albums/BUSINESS/geneva2013/laferrari-700.jpg"
    filename = imageurl.split('/')[-1]
    imagepath = userhome + "/Pictures/" + filename
    ...
    start_yolo(imagepath)
    yolopred= userhome + "/darknet/predictions.jpg"
...
def start_yolo(imagepath):
    req_path = userhome+"/darknet/"
    os.chdir(req_path)
    cmd="./darknet detect cfg/yolo.cfg yolo.weights " + imagepath
